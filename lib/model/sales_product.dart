...
//
//     final salesProductModel = salesProductModelFromJson(jsonString);

import 'dart:convert';

List<SalesProductModel> salesProductModelFromJson(String str) => List<SalesProductModel>.from(json.decode(str).map((x) => SalesProductModel.fromJson(x)));

String salesProductModelToJson(List<SalesProductModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class SalesProductModel {
    ...
    factory SalesProductModel.fromJson(Map<String, dynamic> json) => SalesProductModel(
        id: json["id"],
        name: json["name"],
        slug: json["slug"],
